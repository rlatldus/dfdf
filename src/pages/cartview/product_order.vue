                ...
                <div class="order_box goods-view">
                        ...
                        <div class="ord_left_box">
                            ...
                            <div class="del_info">
                                ...
                                <div class="present_box" v-if="buyType==='P'">
                                    ...
                                    <div class="p_man">
                                        <h4>선물 받는 사람</h4>
                                        <a @click="agentTest()" href="javascript:;" class="on" v-if="isMobile">주소록 찾기 </a>
                                        <p class="txt_info">선물 받는 분에게 배송지 입력을 위한 문자메시지가 발송됩니다.</p>
                                        <ul>
                                            <li>
                                                <strong>받는사람</strong>
                                                <span><input type="text" name="reciverName" id="reciverName" v-model="reciverName" title="상세주소 입력" placeholder="받으시는 분의 이름"></span>
                                            </li>
                                            <li><input type="text" name="reciverTel" id="reciverTel" v-model="reciverTel" title="상세주소 입력" placeholder="받으시는 분의 전화번호"></li>
                                            <li>
                                                <div>
                                        ...
                                        <ul>
                                            ...
                                            >
                                                <a href="javascript:;" class="thumbnail" @click="giftCaerSelect(index)">
                                                    <img :src="getPic(item.uploadFileJson.uuid)" :alt="item.uploadFileJson.originalName">
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="pay_box">
                                ...
                                <div class="gc_input" tabindex='1' >
                                    ...
                                    <div class="gc_popup" id="popup-gift" :class="{'on': this.gcFocus}">
                                        ...
                                        <div class="gcp_con">
                                            <div class="gcp_card" v-for="(item,index) in giftCardData" :key="index">
                                                <p>{{item.cardName}}</p>
                            ...
                            <div class="agree_box">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        개인정보를 제공받는 자 : (파트너 회사 명)
                                        개인정보를 제공받는 자의 개인정보 이용 목적 : 배송 및 CS
                                        제공하는 개인정보 항목 : (구매자)이름, 연락처 (수령자) 이름, 연락처, 주소
                                        개인정보를 제공받는 자의 개인정보 보유 및 이용 기간 : 상법에 의거 5년 보관후 파기
                        ...
                        <div class="ord_right_box">
                            ...
                            <div v-if="buyType=='N'|| buyType=='P'">
                                            ...
                                            <li v-for="(data,index) in cartData" :key="index">
                                                <dl>
                                                    ...
                                                    <dd>
                                                        ...
                                                        <p v-if="data.option !='{}'">
                                                            <span v-for="(optData, index) in this.prodOpt" :key="index" style="display: block;">
                                                                ...
                                                                금액 <span class="font_mont">{{threeCommaAdd(optData.value * optData.value)}}</span>원
                                                            </span>
                                                        </p>
                                                        <p v-else>
                                                            금액 <span class="font_mont">{{this.userGrade == 'VIP'? threeCommaAdd(data.product.vipSellingPrice) : threeCommaAdd(data.product.normalSellingPrice)}}</span>원&nbsp;
                                                            수량 <span class="font_mont">{{data.count}}</span>개
                                                        </p>

                                                        <p v-if="this.userGrade == 'VIP'">
                                                            결제금액 <strong class="font_mont" >{{threeCommaAdd((data.product.vipSellingPrice +this.prodOptTotalPrice)*data.count)}}</strong>원
                                                        </p>
                                                        <p v-else>
                                                            결제금액 <strong class="font_mont" >{{threeCommaAdd((data.product.normalSellingPrice +this.prodOptTotalPrice)*data.count)}}</strong>원
                                                        </p>
                                                    </dd>
                                                </dl>
                                            </li>
                                ...
                                <div class="ord_sum">
                                    <dl>
                                        <dt>주문금액</dt>
                                        <dd><strong class="font_mont">{{this.cartData[0].isOption ==='Y' ? threeCommaAdd(( this.cartData[0].price)*this.cartData[0].count) : threeCommaAdd(( this.cartData[0].price)*this.cartData[0].count)}}</strong>원</dd>
                                    </dl>
                                    <dl>
                                        <dt>배송 비</dt>
                                    ...
                                    <dl class="total">
                                        <dt>소계</dt>
                                        <dd><strong class="font_mont">{{this.cartData[0].isOption ==='Y' ? threeCommaAdd(( this.cartData[0].price)*this.cartData[0].count +this.cartData[0].product.shippingPrice) : threeCommaAdd(( this.cartData[0].price)*this.cartData[0].count +this.cartData[0].product.shippingPrice)}}</strong>원</dd>
                                    </dl>
                    ...
                    <div class="fix_btn for-m-flex">
                        <button type="button" class="btn" @click="postMobData()">
                            <span class="buy_01"><strong class="font_mont">{{buyType==='Y' ? threeCommaAdd(this.cartTotal - this.giftCard) : threeCommaAdd(this.cartData[0].totalPrice - this.giftCard)}}</strong>원 구매하기</span>
                        </button>
                    </div>
                </div>
            </div>
...
export default {
    ...
    created () {
        ...
        this.bagId = this.$store.state.bagId;
    ...
    methods: {
        ...
        async load(){
            ...
            await axios.post(url,tmpId,{headers: {T: localStorage.getItem("T"), I: localStorage.getItem("I")}}).then(res=>{
                ...
                console.log(`this.prodOpt`)
                console.log(this.prodOpt)
                this.pending = false;
                if(!this.cartData[0].isOption){
        ...
        async getCartData(){
            ...
            let reqUser = { bagIds: this.$store.state.bagId}
            await axios.post(url,reqUser).then(res=>{
                ...
                this.cartTotal = this.cartSumProductPrice + this.cartSumshippingPrice - this.giftCard
                this.pending = false;
			})
        },
		async postData(){
            ...
            let totalPriceData={}
            let url =''
            this.totalPrice = this.buyType==='Y'? this.cartTotal  :
                            this.cartData[0].isOption ==='Y' ?
                            this.cartData[0].totalPrice *this.cartData[0].count +this.cartData[0].product.shippingPrice  :
        ...
        async postMobData(){
            ...
            await axios.post(tmpUrl,tmpData).then(res=>{
            })
        ...
        async saveShipping(){
            ...
            let shippingData={}
                ...
                await axios.post(url, shippingData).then(res=>{
                ...
                shippingData={
                    ...
                    sendMsg: this.escapeRegex(this.sendMsg),
        ...
        async giftCardLoad(){
            ...
            await axios.post(url, nullData).then(res=>{
                ...
                // 요청받은 이미지 처음에 나오게 수정
                let findSetImage = false;
                if (this.giftCardImage?.length > 0) {
                    this.giftCardImage.forEach((item, index) => {
                        if (item?.uploadFileJson?.originalName) {
                            if (item?.uploadFileJson?.originalName == '1024_굿샵 선물하기 카드-02.jpg') {
                                this.giftCardDataSet = item;
                                findSetImage = true;
                            }
                        }
                    });
                ...
                // 해당하는 파일 이름 찾지 못한경우 0번쨰 이미지 들어감
                if (findSetImage == false) {
        ...
        makePrice(val){
			...
			switch(val) {
				...
				case 4 : result = '글렌로스'; break;
				case 5 : result = '동래 베네스트'; break;
			}
			return result
