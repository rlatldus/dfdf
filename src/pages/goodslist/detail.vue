                ...
                <div class="goods-view-body">
                    ...
                    <div class="goods-view-header for-m">
                        <div class="section-01">
                            <div class="section-left">
                                <div class="now-cate-link">
                                    <a href="javscript:;">{{this.productItem.brand.name}}</a>
                                </div>
                                <div class="goods-tag">
                                    <span class="tag type-free" v-if="this.productItem.shippingFree === 'Y'">무료배송</span>
                                    <span class="tag type-new" v-if="this.productItem.isNew === 'Y'">NEW</span>
                    ...
                    <div class="goods-info">
                        ...
                        <div class="option-box" style="position: relative; z-index: 2;">
                            ...
                            <div class="option-value flex-between">
                                <span>2-6개월 무이자 할부 지원</span>
                                <div class="int-box">
                                    <button type="button" class="int-free" @click="ifpPop = true">무이자 할부안내</button>
                        ...
                        <!-- PC 재입고 알림 신청 -->
                        <!--TODO: 보안성-->
                        <div class="option-box for-pc" v-if="soldOut_cnt>0 || (productItem.isCombine !='true'&& productItem.stock==0)" >
                        ...
                        <div class="goods-buy-box for-pc">
                            ...
                            <div class="has-comment" v-if="this.productItem.isReservation=='Y'">
                                <p class="comment primary top" v-if="this.productItem.reservationMinWeek != null && this.productItem.reservationMaxWeek != null">* 예약 주문 상품입니다. (최소 {{this.productItem.reservationMinWeek}}주에서 최대 {{this.productItem.reservationMaxWeek}}주 소요)</p>
                                <p class="comment primary top" v-else-if="this.productItem.reservationMinWeek != null">* 예약 주문 상품입니다. (최소 {{this.productItem.reservationMinWeek}}주 소요)</p>
                                <p class="comment primary top" v-else-if="this.productItem.reservationMaxWeek != null">* 예약 주문 상품입니다. (최대 {{this.productItem.reservationMaxWeek}}주 소요)</p>
                            </div>
                                        ...
                                        <ul class="select-cont" >
                                            ...
                                            >
                                                <a href="javascript:;" @click="pushFragmentOpt('co', index, item.index, optidx, optItem,item.is_necessary, `${item.index}_${optidx}`); optionCloseForRequire($event);">
                                                    ...
                                                    <span class="img" v-else-if="optItem.type == 'img'"><img :src="getPic(optItem.value.uuid)" alt="옵션 이미지"></span>
                                ...
                                <div class="option-value">
                                    <div class="option-value-change">
                                        ...
                                        <div class="ovc-bottom">
                                            <div class="count-change" style="display: none;">
                                                <!-- TODO 20221027 -->
                            ...
                            <div class="option-box goods-all-price-wrap">
                                ...
                                <div class="option-value">
                                    <div class="goods-all-price">
                                        <span class="price mont" v-if="(this.userGrade == 'VIP') && (this.productItem.vipNormalPrice)">{{this.productItem.hasOption =='Y' ? threeCommaAdd(getTotalOptionPay + this.productItem.vipSellingPrice) : threeCommaAdd(Number(this.productItem.vipSellingPrice) * Number(this.optionSingleCount) + Number(this.productItem.shippingPrice))}}</span>
                                        <span class="price mont" v-else>{{this.productItem.hasOption =='Y' ? threeCommaAdd(getTotalOptionPay +this.productItem.normalSellingPrice) : threeCommaAdd(Number(this.productItem.normalSellingPrice) * Number(this.optionSingleCount) + Number(this.productItem.shippingPrice))}}</span>
                                        <span class="unit">원</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="goods-detail-cont" :class="{'on' :this.detailTabIndex == 1}">
                            ...
                            <table class="goods-detail-table">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">모델명</th>
                                        <td>[단독판매] 타이틀리스트 TSi2/TSi3 드라이버(DIAMAMA BF)</td>
                                    </tr>
                                    <tr>
                                        <th scope="row">색상</th>
                                        <td>블랙</td>
                                    ...
                                    <tr>
                                        <th scope="row">제조사 <br/>(수입자/병행수입)</th>
                                        <td>아쿠쉬네트코리아</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p>
                                                ...
                                                굿샵 배송 상품의 총 결제금액 20,000원 이상일 경우 무료배송 됩니다.<br>
                                                도서, 산간, 오지 일부 지역은 배송비가 추가될 수 있습니다.
                                            </p>
                                            <p>
                                                <strong>배송가능일: 3일</strong>
                                                배송가능일이란 본 상품을 주문하신 고객님들께 상품 배송이 가능한 기간을 의미합니다.<br>
                                                연휴 및 공휴일은 기간 계산시 제외하며 현금 주문일 경우 입금일 기준 입니다.
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
                            ...
                            <table class="goods-detail-table">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">교환/반품 신청방법</th>
                                        <td>
                                            <p>
                                                마이페이지 내 주문내역에서 신청가능하며, <br />
                                                반품 신청의 경우 택배회수 / 골프장 방문중 선택하여 신청 가능합니다.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">교환/반품 신청기간</th>
                                        <td>
                                            <p>
                                    ...
                                    <tr>
                                        <th scope="row">교환/반품 불가안내</th>
                                        <td>
                                            <p>
                                                <strong>고객님의 사유에 의한 교환 및 반품이 불가한 경우</strong>
                                                1. 배송이 완료된 후 15일이 경과한 경우<br>
                                                2. 포장 훼손 및 사용 또는 일부 소비, 구성품 누락 및 상품의 결함 발생으로 인해 상품의 가치가 훼손된 경우
                                            </p>
                                            <p>
                                                <strong>당사의 사유에 의한 교환 및 반품이 불가한 경우</strong>
                                                1. 배송 받으신 날로부터 3개월, 혹은 그 사실을 알 수 있었던 날로 부터 30일이 경과한 경우<br>
                                                2. 당사의 귀책(상품의 불량, 생산 및 제조 및 배송 간의 파손 등)으로 인한 현상이 아닌 해당 상품의 고유한 특성,<br>
                                                &nbsp;&nbsp;&nbsp;&nbsp;혹은 상품 수령 후 고객님의 과실로 인한 문제임이 규명된 경우
                                            </p>
                                        </td>
                                    </tr>
                                </tbody>
                                            ...
                                            <div class="tgqb-list" :class="{'type-secret' : item.isSecret == 'Y'}" :id="'qnaList'+item.id">
                                                <div class="tgqb-header">
                                                    ...
                                                    <div class="header-info">
                                                        ...
                                                        <!--여기--><span class="title" v-else><span v-html="changeBr(item.textTitle)"></span></span>
                                                        <div class="user-info">
...
export default {
    ...
    methods: {
        ...
        async buyProductItemNow(){ // 바로구매
            ...
            if(this.productItem.isCombine==='true'&& Object.keys(this.combineOpt).length === 0){ alert('필수 옵션을 선택해 주세요'); return false;}
            ...
            if(this.pickupMethod==='1'){
                ...
                prodData = {
                    ...
                    requiredOption : this.productItem.hasOption =='Y' ? JSON.stringify(this.combineOpt) : '',
                    chooseOption : JSON.stringify(this.noCombineOpt),
                    deliveryType: this.productItem.shippingService ==='holiday_seolnal'||'holiday_chuseock'|| 'holiday' ? "HolidayDelivery"  : 'AnniversaryDelivery',
                    isReservation: this.productItem.isReservation,
                    //기념일 배송 특화
        ...
        async getInCart(){ //장바구니 구매
            ...
            if(this.productItem.isCombine==='true'&& Object.keys(this.combineOpt).length === 0){
            ...
            await axios.post(url,sendData).then(res=>{
                console.log('success to get in cart')
                console.log(res);
				this.cartLoading = false;
                if(res.data.data ===false){alert('이미 담긴 상품입니다')}
				else{
        ...
        async draw_check_option(has_inventory) {
            ...
            for await (const [key, value] of Object.entries(no_tmp_sold_out)){
                this.$refs[`${key}`][0].classList.remove('soldout')
                this.$refs[`${key}`][1].style.opacity = '100%'
                if(value === 0 || value === '0') {
                    console.log(`disabled option`);
            ...
            for await (const [key, value] of Object.entries(no_tmp_hidden)){
                this.$refs[`${key}`][0].style.display = 'block'
                this.$refs[`${key}`][1].style.display = 'block'
                if(value === 0 || value === '0') {
                    console.log(`hide option`);
        ...
        pushFragmentOpt(type,index,group,optidx,optItem,is_necessary, stock_check) {
            ...
            if (type == 'uo') {
                if (this.optionJson[`${type}_${group}_${optItem.name}`].stock == 0) {
                    alert('품절 옵션입니다.');
                    return;
                }
            }
